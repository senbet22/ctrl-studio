...
export default function BackToTopButton() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-6 right-6 z-50 p-2 px-2 cursor-pointer rounded-full bg-primary/30 hover:bg-secondary/10 focus:outline-none  shadow-md shadow-gray-700 transition-opacity duration-300 ${
